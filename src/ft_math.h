...
/*   Updated: 2022/12/13 14:38:17 by hseppane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_float3	float3_rot_x(const t_float3 *f, float rad);
t_float3	float3_rot_y(const t_float3 *f, float rad);
t_float3	float3_rot_z(const t_float3 *f, float rad);
...
t_float4x4	float4x4_rotate(const t_float4x4 *l, const t_float3 *rotation);
